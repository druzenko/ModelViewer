    ...
    , mElementSizeInBytes(elementSize)
{
    ...
    if (SUCCEEDED(Graphics::g_Device->CreateCommittedResource(&heapProperties, D3D12_HEAP_FLAG_NONE, &bufferDesc, D3D12_RESOURCE_STATE_COMMON, nullptr, IID_PPV_ARGS(&m_pResource))))
    {
#ifdef _DEBUG
